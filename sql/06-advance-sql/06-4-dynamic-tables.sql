...
-- What is the problem with this? is this dynamic? what if the source changes but we would like to add new columns to the table, 
-- we are doing that with schema evolution but not at this step
