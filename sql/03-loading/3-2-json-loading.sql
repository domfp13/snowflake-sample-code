...
PUT file://///Users/eplata/Developer/personal/snowflake-sample-code/sql/03-loading/SNOWBANK_PUBLIC_ACCOUNTS_1.json @SNOWPROCORE.PUBLIC.STAGE_INTERNAL_ACCOUNTS;

-- SELECT DATA FROM THE STAGE, HERE THE DATA HAS NOT BEEN LOADED YET INTO A TABLE.
SELECT *, metadata$filename, metadata$file_row_number FROM @SNOWPROCORE.PUBLIC.STAGE_INTERNAL_ACCOUNTS (FILE_FORMAT => SNOWPROCORE.PUBLIC.FILE_FORMAT_JSON_GENERIC) SAMPLE(100 ROWS);
...
PUT file://///Users/eplata/Developer/personal/snowflake-sample-code/sql/03-loading/SNOWBANK_PUBLIC_ACCOUNTS_2.json @SNOWPROCORE.PUBLIC.STAGE_INTERNAL_ACCOUNTS;
LIST @SNOWPROCORE.PUBLIC.STAGE_INTERNAL_ACCOUNTS;
